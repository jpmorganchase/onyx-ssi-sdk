...
import * as DIDRegistry from './contracts/DIDRegistryZK.json'

export class ZKDIDMethod implements DIDMethod {
    name = 'zk';
    providerConfigs: ZKProviderConfigs;
    web3Provider: Provider

    constructor(providerConfigs: ZKProviderConfigs) {
 ...
 */
export interface ZKProviderConfigs {
    /**
